...
OUT = Path(__file__).parent / "titles"
OUT.mkdir(exist_ok=True)
font_path = "/System/Library/Fonts/Supplemental/Arial Bold.ttf"
items = [
    ("Një ditë si NDIHMËS", "top", 68),
    ("3 role · 1 ekip", "top", 68),
    ("Shpjego qartë · Respekto çdo “jo”", "bottom", 52),
    ("Privatësia dhe siguria, gjithmonë", "top", 58),
    ("Ndihmësi dorëzon · Udhëheqësi raporton", "bottom", 48),
    ("Asnjëherë vetëm · Gjithmonë ekip", "top", 58),
]
