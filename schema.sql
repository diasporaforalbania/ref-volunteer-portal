...
-- ============================================================================
-- HAPI I FUNDIT — bëni veten admin.
--
-- 1) Hapni portalin dhe regjistrohuni me email-in tuaj.
-- 2) Kthehuni këtu dhe ekzekutoni (zëvendësoni email-in):
--
    update public.volunteers
       set role = 'admin', status = 'approved', approved_at = now()
     where id = (select id from auth.users where email = 'gled.guri@gmail.com');

-- Që andej e tutje miratoni vullnetarët e tjerë nga skeda "Paneli".
-- ============================================================================
